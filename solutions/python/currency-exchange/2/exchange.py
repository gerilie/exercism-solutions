...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    new_rate = exchange_rate + exchange_rate / 100 * spread
    new_exchanged_currency = exchange_money(budget, new_rate)

    bill_value = new_exchanged_currency // denomination
    maximum_value = bill_value * denomination
